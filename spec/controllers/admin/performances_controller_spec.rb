...
describe Admin::PerformancesController do
  ...
  # Admin::Performance. As you add validations to Admin::Performance, be sure to
  ...
  describe "GET index" do
    it "assigns all admin_performances as @admin_performances" do
      performance = Admin::Performance.create! valid_attributes
      get :index
      assigns(:admin_performances).should eq([performance])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new performance as @performance" do
      get :new
      assigns(:performance).should be_a_new(Admin::Performance)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved performance as @performance" do
        ...
        Admin::Performance.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested performance" do
        performance = Admin::Performance.create! valid_attributes
        # Assuming there are no other admin_performances in the database, this
        # specifies that the Admin::Performance created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Admin::Performance.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
